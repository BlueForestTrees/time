...
public class WebCrawler implements Runnable {
  ...
  /**
   * The rest instance that has created this crawler thread. This
   * reference to the rest can be used for getting configurations of the
   ...
   * mainly used by the rest to detect whether all of the crawler
   ...
   *            the rest that manages this crawling session
   */
   ...
   * data to their rest. The rest then puts these local data in a
      ...
      if (assignedURLs.isEmpty()) {
        ...
        for (WebURL curURL : assignedURLs) {
          ...
          if (myController.isShuttingDown()) {
            logger.info("Exiting because of rest shutdown.");
            return;
          }
        }
      }
