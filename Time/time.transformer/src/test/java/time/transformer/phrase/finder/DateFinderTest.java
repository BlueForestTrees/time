...
public class DateFinderTest {
	...
	@Test
	public void ilYA15() {
		assertOnly(ilYAFinder, yearIs(-2000), "Le chow-chow est une race de chien qui s'est déployée en Chine il y a environ 4000 ans.");
	}

	@Test
	public void ilYA14() {
		assertOnly(ilYAFinder, ilyaYearIs(-12000), "Tombe vieille de 12 000 ans découverte dans le nord d’Israël.");
	}

	@Test
	public void ilYA11() {
		assertOnly(ilYAFinder, yearIs(-3000), "La Grande Encyclopédie soviétique affirme que le soja est originaire de Chine ; il y a environ 5000 ans.");
	}

	@Test
	public void ilYA1() {
		assertOnly(ilYAFinder, ilyaYearIs(-400000), "Voici 400 000 ans seulement que plusieurs espèces d’hommes ont commencé à chasser régulièrement le gros gibier");
	}

	@Test
	public void ilYA2() {
		assertOnly(ilYAFinder, ilyaYearIs(-600000), "Voici 600000 ans seulement que plusieurs espèces d’hommes ont commencé à chasser régulièrement le gros gibier");
	}

	@Test
	public void ilYA3() {
		assertOnly(ilYAFinder, ilyaYearIs(-800000), "Il y a 800 000 ans, déjà, certaines espèces humaines faisaient peut-être, à l’occasion, du feu.");
	}

	@Test
	public void ilYA4() {
		assertOnly(ilYAFinder, ilyaYearIs(-300000), "Voici environ 300 000 ans, Homo erectus, les Neandertal et les ancêtres d’Homo sapiens faisaient quotidiennement du feu");
	}

	@Test
	public void ilYA5() {
		assertOnly(ilYAFinder, ilyaYearIs(-150000), "Malgré les bénéfices du feu, les humains d’il y a 150 000 ans étaient encore des créatures marginales.");
	}

	@Test
	public void ilYA8() {
		assertOnly(ilYAFinder, ilyaYearIs(-50000), "Les derniers restes d’Homo soloensis voici 50 000 ans.");
	}

	@Test
	public void ilYA9() {
		assertOnly(ilYAFinder, ilyaYearIs(-50000), "Les derniers restes d’Homo soloensis voici environ 50 000 ans.");
	}

	@Test
	public void ilYA10() {
		assertOnly(ilYAFinder, ilyaYearIs(-50000), "Les derniers restes d’Homo soloensis vieux de 50 000 ans.");
	}

	@Test
	public void ilYA12() {
		assertOnly(ilYAFinder, ilyaYearIs(-50000), "Les derniers restes d’Homo soloensis datent d'environ 50 000 ans.");
	}

	@Test
	public void ilYA6() {
		assertOnly(ilYAFinder, ilyaYearIs(-50000), "Les derniers restes d’Homo soloensis vieux d'environ 50 000 ans.");
	}

	@Test
	public void ilYA7() {
		assertOnly(ilYAFinder, ilyaYearIs(-40000), "L’Homo denisova disparut peu après, il y a quelque 40 000 ans.");
	}

	@Test
	public void ilYA16() {
		assertOnly(ilYAFinder, ilyaYearIs(-15000), "mais nous avons des preuves incontestables de la domestication des chiens il y a près de 15 000 ans.");
	}

	@Test
	public void ilYA17() {
		assertOnly(ilYAFinder, ilyaYearIs(-30000), "des outils ne s’est pas sensiblement améliorée au cours des 30 000 dernières années.");
	}

	@Test
	public void ilYA18() {
		assertOnly(ilYAFinder, ilyaYearIs(-30000), "intercontinentaux pourvus d’ogives nucléaires alors que, voici 30 000 ans, nous n’avions");
	}

	@Test
	public void ilYA19() {
		assertOnly(ilYAFinder, ilyaYearIs(-80), "il y a 80 ans");
	}

	@Test
	public void ilYA20() {
		assertOnly(ilYAFinder, ilyaYearIs(-45000), "Les villages de pêche ont pu apparaître sur les côtes des îles indonésiennes dès 45 000 ans.");
	}

	@Test
	public void near0() {
		assertOnly(nearJcFinder2, yearIs(2000), "Vers l'an 2000, gros bug.");
	}
	...
	public void precise4() {
		assertOnly(preciseFinder, dateIs(date(9, Month.FEBRUARY, 968)), "Il a disputé son premier test match le 9 fév. 968, contre l'équipe d'Irlande, et son dernier test match fut contre l'équipe d'Australie.");
	}

	@Test
	public void precise5() {
		assertOnly(preciseFinder, dateIs(date(9, Month.DECEMBER, 968)), "Il a disputé son premier test match le 9 déc. 968, contre l'équipe d'Irlande, et son dernier test match fut contre l'équipe d'Australie.");
	}

	@Test
	public void precise6() {
		assertOnly(preciseFinder, dateIs(date(9, Month.DECEMBER, 968)), "9 déc. 968, contre l'équipe d'Irlande, et son dernier test match fut contre l'équipe d'Australie.");
	}

	@Test
	public void precise7() {
		assertOnly(preciseFinder, dateIs(date(1, Month.JUNE, 2014)), "En juin 2014, Alibaba achète les 34 % qu'il ne détient pas dans UCWeb, entreprise chinoise de services pour l'internet mobile, opération valorisant UCWeb (en) à 1,9 milliard d'euros");
	}
	...
	public void precise11() {
		assertOnly(preciseFinder, dateIs(date(1, Month.DECEMBER, 1935)), "Woody Allen, est un réalisateur, scénariste, acteur et humoriste américain, né le 1er décembre 1935 à New York.");
	}

	@Test
	public void jc27() {
		assertOnly(jcFinder, yearIs(1790), "L'invention du Camenbert date de 1790");
	}

	@Test
	public void precise10() {
		assertOnly(preciseFinder, dateIs(date(1, Month.FEBRUARY, 1919)), "La guerre soviéto-polonaise, ou guerre russo-polonaise (février 1919) est l'une des conséquences de la Première Guerre mondiale.");
	}
	...
	@Test
	public void jc17() {
		assertOnly(jcFinder, yearIs(-3100), "En 3100 avant notre ère, toute la vallée du Nil inférieur était unie dans le premier royaume égyptien.");
	}

	@Test
	public void jc18() {
		assertOnly(jcFinder, yearIs(-350), "En 350 avant notre ère, aucun Romain n’aurait imaginé faire voile droit sur la Grande-Bretagne et la conquérir.");
	}

	@Test
	public void jc20() {
		assertOnly(jcFinder, yearIs(1873), "En 1873, Jules Verne imagina que Phileas Fogg, riche aventurier britannique, pourrait faire le tour du monde en 80 jours.");
	}

	@Test
	public void jc0() {
		assertOnly(jcFinder, yearIs(1827),
	...
	@Test
	public void nearJc5() {
		assertOnly(nearJcFinder, yearIs(-2000), "Les roues à rayons et à jantes, plus légères, seraient apparues environ 2000 ans av. J.-C..");
	}

	@Test
	public void nearJc5bis() {
		assertOnly(nearJcFinder, yearIs(-2001), "Les roues à rayons et à jantes, plus légères, seraient apparues environ 2001 ans av. J.-C..");
	}

	@Test
	public void jc6() {
		assertOnly(nearJcFinder3, yearIs(-3500), "L'invention de la roue est estimée située vers 3500 avant J.-C. à Sumer en basse Mésopotamie.");
	}
	...
	@Test
	public void jc8() {
		assertOnly(nearJcFinder3, yearIs(-4500), "Néolithique, soit vers 4500 av. J.-C. Il s’agit");
	}
	...
	@Test
	public void jc10() {
		assertOnly(nearJcFinder3, yearIs(-2300), "La civilisation olmèque a débuté avec une production en abondance de poterie, vers 2300 avant notre ère");
	}

	@Test
	public void jc26() {
		assertOnly(jcFinder, yearIs(1960), "du Paraguay jusque dans les années 1960, offrent un aperçu");
	}

	@Test
	public void nearLess12() {
		assertOnly(nearLessFinder, yearIs(-5300), "Des indices de culture de céréales et de domestication du chien, du cochon, du mouton et de la chèvre dans la région de Tétouan, remontant à environ -5300, constituent la plus ancienne trace connue d'agriculture en Afrique du Nord.");
	}

	@Test
	public void jc13() {
		assertOnly(nearJcFinder3, yearIs(-3500), "au sein des chasseurs-cueilleurs de la culture Botaï, vers 3500 av. J.-C., cool.");
	}

	@Test
	public void jc15() {
		assertOnly(preciseFinder, dateIs(date(17, Month.JANUARY, -3380)), "L' éclipse de Lune est celle du 17 janvier 3380 av. J.-C., qui aurait été décrite par les Mayas en Amérique centrale.");
	}

	@Test
	public void jc16() {
		assertOnly(jcFinder, yearIs(-500), "A partir de l'an 500 avant J.C., il s'est passé des choses.");
	}

	@Test
	public void jc19() {
		assertOnly(nearJcFinder2, yearIs(1990), "Or, après 1990, on a eu la surprise de constater le contraire.");
	}

	@Test
	public void jc22() {
		assertOnly(jcFinder, yearIs(500), "date de 500, il s'est passé des choses.");
	}

	@Test
	public void jc25() {
		assertOnly(jcFinder, yearIs(1500), "cela apparaît à partir de 1500.");
	}

	@Test
	public void jc23() {
		assertOnly(jcFinder, yearIs(1500), "cela apparaît à partir de 1500 souvent.");
	}

	@Test
	public void jc21() {
		assertOnly(jcFinder, yearIs(1769), "L'invention de l'automobile date de 1769 (Charles Cugnot).");
	}

	@Test
	public void jc24() {
		assertOnly(jcFinder, yearIs(-500), "A partir de l'an 500 avant J.C. pour la plupart il s'est passé des choses.");
	}

	@Test
	public void jc28() {
		assertOnly(jcFinder, yearIs(1456), "Les chats sont bleus depuis 1456.");
	}

	@Test
	public void testMilliard0() {
		assertOnly(milliardFinder, milliardYearIs(1), "Il débute par un événement bien connu : la limite Crétacé-Tertiaire, il y a environ 1 milliard d'années.");
	}

	@Test
	public void testMilliard1() {
		assertOnly(milliardFinder, milliardYearIs(2.4d), "La Grande Oxydation, également appelée catastrophe de l'oxygène ou crise de l'oxygène, est une crise écologique qui a eu lieu il y a environ 2,4 milliards d'années, au Paléoprotérozoïque, dans les océans et l'atmosphère terrestre.");
	}

	@Test
	public void testMilliard2() {
		assertOnly(milliardFinder, milliardYearIs(25.4d), "Super il y a environ 25,4 milliards d'années, à une autre époque.");
	}

	@Test
	public void testMilliard3() {
		assertOnly(milliardFinder, milliardYearIs(25.49d), "Super il y a environ 25,49 milliards d'années, à une autre époque.");
	}

	@Test
	public void testMillion1() {
		assertOnly(milliardFinder, millionYearIs(65), "Il débute par un événement bien connu : la limite Crétacé-Tertiaire, il y a environ 65 millions d'années.");
	}

	@Test
	public void testMillion4() {
		assertOnly(milliardFinder, millionYearIs(100), "Les abeilles sont apparues il y a 100 millions d'années.");
	}

	@Test
	public void testMillion2() {
		assertOnly(milliardFinder, millionYearIs(2.5d), "Il débute par un événement bien connu : la limite Crétacé-Tertiaire, voici environ 2,5 millions d'années, issus d’un genre antérieur de singe,");
	}

	@Test
	public void testMillion3() {
		assertOnly(milliardFinder, millionYearIs(2.5d), "Les humains sont apparus en Afrique de l’Est voici environ 2,5 millions d'années, issus d’un genre antérieur de singe,");
	}

	@Test
	public void testMillion5() {
		assertOnly(milliardFinder, millionYearIs(3d), "Les humains sont apparus en Afrique de l’Est voici environ trois millions d’années, issus d’un genre antérieur de singe,");
	}

	@Test
	public void roman0() {
		assertOnly(romanFinder, yearIs(-700), "Daté du VIIIe siècle av. J.-C., a été retrouvé dans les environs un ostracon sur lequel");
	}
	...
	@Test
	public void roman3() {
		assertOnly(romanFinder, yearIs(1700), "des rabbins juifs polonais du XVIIIe siècle aux puritains brûleurs");
	}
	...
	public void precise12() {
		assertOnly(preciseFinder, dateIs(date(10, Month.FEBRUARY, 1984)), "Slimane Médini est né le 10 Février 1984 à Gournay-en-bray");
	}

	private void assertNoDateIn(String phrase) {
