...
import time.dumper.writer.MongoWriter;
...
public class DumperFactory {
    ...
    public DumperController buildController(DumperConfig config) throws Exception {
        ...
        configureStorage(storagePath, maxFileSize);
    ...
    private void configureStorage(String storagePath, String maxFileSize) {
        ...
        RollingRandomAccessFileAppender appender = RollingRandomAccessFileAppender.createAppender(fileName, filePattern, append, name, immediateFlush, bufferSizeStr, policy, strategy, layout, null, "true", "true", null, config);
