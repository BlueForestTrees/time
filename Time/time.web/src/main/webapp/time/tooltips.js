(function() {
    ...
    tooltips.prototype.mouseMoveOnBar = function(event) {
        ...
        //Si on a pas de bucket à la souris on en crée un factice pour générer le tooltip quand même.
        if(bucket === null){
            bucket = {bucket : bar.getBucketPosition(mousePosition), scale : bar.scale};
        }
    ...
    tooltips.prototype.toolTipAt = function(tooltip, at) {
        ...
        var toolTipText = Time.tooltips.getTooltipText({scale:scale, bucket:bucketPosition});
