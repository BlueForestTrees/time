...
/**
 * The rest that manages a crawling session. This class creates the
...
public class CrawlController extends Configurable {
  ...
  /**
   * Once the crawling session finishes the rest collects the local data
  ...
  /**
   * Once the crawling session finishes the rest collects the local data of the crawler threads and stores them
   * in a List.
